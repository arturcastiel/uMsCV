function [pressure,errorelativo,flowrate,flowresult,RHS_old,q]=solverpressurempfad(kmap,fonte,...
...
%falta ajustar as condi��es de po�o
[ M_old, RHS_old ] = globalmatrixmpfadn( w,s, Kde, Ded, Kn, Kt, nflag, Hesq,wells,mobility,fonte);
