...
%Programer: M�rcio Souza; Luiz Eduardo
%--------------------------------------------------------------------------
%Goals:
...
%This FUNCTION  
%--------------------------------------------------------------------------
% LAYANE: Mudei da linha 157 a 165 para gerar os vetores da velovidade

function postprocessorTMS_2(u,v,pressure,watersaturation,step,folder, fname)
global coord elem
%--------------------------------------------------------------------------
...
%Write data related to velocity
% componente x
fprintf(fid,'SCALARS u double 1 \r\n');
fprintf(fid,'LOOKUP_TABLE default \r\n\r\n');
fprintf(fid,'%26.16E \r\n',u);
% componente y
fprintf(fid,'SCALARS v double 1 \r\n');
fprintf(fid,'LOOKUP_TABLE default \r\n\r\n');
fprintf(fid,'%26.16E \r\n',v);
